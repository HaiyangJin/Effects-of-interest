...
The results were not displayed as none of these effects could test the directional effects specified in EOI directly. Thus, we first tested that simple effect (i.e., post-test vs. pre-test in the training group) with the one-tailed test:
...
The CBER in the hypothetical training study refereed to the probability of concluding the training effectiveness when the statistical null hypotheses for all the tests specified in EOI were true. CBER in the hypothetical study was estimated with following simulation.
