...
The results were not displayed as none of these effects could test the directional effects specified in EOI directly. Thus, we first tested that simple effect (i.e., post-test vs. pre-test in the training group):
...
The above result showed that the _d_' in the post-test was significantly better than the pre-test in the training group. Next, we tested the two-way interaction (i.e., the increase of _d_' in the training group relative to the control group):
...
Next, we tested one that simple effect (i.e., post-test vs. pre-test in the training group):
...
This result showed that RT in post-test was shorter than the pre-test in the training group. Next, we examined the two-way interaction (i.e., the decrease of RT in the training group relative to the control group):
...
This result showed that the _d_' of the post-test was significantly better than the pre-test in the training group. Next, we tested the two-way interaction:
...
The CBER in the hypothetical training study refereed to the probability of concluding the training effectiveness when the statistical null hypotheses for all the tests specified in EOI were true. CBER was estimated with following simulation.
